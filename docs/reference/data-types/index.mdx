...
<CardGroup cols={2}>
  ...
  <Card title="User-defined types">
    Give a stable catalog identity to an underlying physical type with experimental [`CREATE TYPE`](/reference/statements/create/type).
  </Card>
